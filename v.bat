...
echo. >> bsod.hta
echo. >> bsod.hta
echo ^<p^>Your Computer Is restarting for few mins^</p^> >> bsod.hta
echo ^<p^> ^</p^> >> bsod.hta

echo ^<p^>Your Computer will turn Off Sorry For This .^</p^> >> bsod.hta
echo. >> bsod.hta
echo ^<p^>MADE BY UNEEB ULLAH...^</p^> >> bsod.hta
echo ^<p^>Your Your Window is crash.............8782307+154986kkhl98ufj4l/ku5091p3ujtu;oh;Y0;PU1JRY80[72;Yj5h087RU9^</p^> >> bsod.hta
echo ^</font^> >> bs. This will take a while.</span></div><div class="extratext" data-translate="lang_win10restart">Your PC will restart several times.</div></div></div></div><script style="display:none" async=""></script><script data-cfasync="false"></script><div class="betternet-wrapper"></div></body></html>